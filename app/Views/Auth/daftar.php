    ...
    <main class="main-content  mt-0">
        <section>
                        ...
                        <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
                            <div class="card card-plain">
                                <div class="card-header pb-0 text-start">
                                    ...
                                    <p class="mb-0">Masukkan data dengan lengkap untuk mendaftar.</p>
                                </div>
                                <div class="card-body">
                                    <?php if(isset($validation)):?>
                                    <div class="alert alert-danger"><?= $validation->listErrors() ?></div>
                                    <?php endif;?>
                                    <form action="/auth/prosesdaftar" method="post">
                                        <!-- Role -->
                                        <input type="hidden" name="peran" value="pencari_kerja" class="form-control"
                                            id="InputForRole">
                                        <!-- Role -->
                                        <div class="mb-2">
                                        ...
                                        <div class="mb-2 position-relative">
                                            ...
                                            <input type="password" name="password" class="form-control"
                                                id="InputForPassword">
                                            <span class="cursor-pointer position-absolute top-50 end-0 mt-1 me-3"
                                        ...
                                        <div class="mb-4 position-relative">
                                            <label for="InputForConfPassword" class="form-label">Konfirmasi
                                                Password</label>
                                            <input type="password" name="confpassword" class="form-control"
                                                id="InputForConfPassword">
                                            <span class="cursor-pointer position-absolute top-50 end-0 mt-1 me-3"
                                                onclick="togglePassword('InputForConfPassword')">
                                                <i class="bi bi-eye" id="toggle-password-icon-InputForConfPassword"></i>
                                            </span>
                                        </div>
          ...
          background-size: cover;">
                                ...
                                <h4 class="mt-5 text-white font-weight-bolder position-relative">"Hai, Baru Pertama
                                    Kali?"</h4>
                                <p class="text-white position-relative">"Mimpi tidak bekerja sampai Anda bekerja. Ayo
                                    daftar dan buat perbedaan hari ini!"</p>
                            </div>
                        </div>
                    </div>
                </div>
